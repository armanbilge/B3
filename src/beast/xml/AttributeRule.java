...
public class AttributeRule implements XMLSyntaxRule {
	...
	/**
	 * Creates a optional attribute rule.
	 */
	...
	public static AttributeRule newIntegerArrayRule(String name, boolean optional, String description) { return new AttributeRule(name, Integer[].class, optional, description); }
	...
	public String htmlRuleString(XMLDocumentationHandler handler) {
		String rule =
			"<div class=\"" + (optional ? "optional" : "optional") + "rule\"> " +
	...
	/**
	 * @return true if the given object is compatible with the optional class.
	 */
