...
public abstract class AbstractXMLObjectParser<T> implements XMLObjectParser<T> {

    public final T parseXMLObject(XMLObject xo, String id, ObjectStore store, boolean strictXML)
...
//                    System.err.println("WARNING: " + msg);
    ...
    public abstract T parseXMLObject(XMLObject xo) throws XMLParseException;
