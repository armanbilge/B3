...
public class BeastParser extends XMLParser {
    ...
    public BeastParser(String[] args, List<String> additionalParsers, boolean verbose, boolean parserWarnings, boolean strictXML) {
        super("beast", parserWarnings, strictXML);
        ...
        addGlobalElementCollection(Likelihood.class, Likelihood.FULL_LIKELIHOOD_SET);
        addGlobalElementCollection(Model.class, Model.FULL_MODEL_SET);
        addGlobalElementCollection(Parameter.class, Parameter.FULL_PARAMETER_SET);
...
//        }
    ...
    private void setup(String[] args) {
        ...
        addXMLObjectParser(Property.PARSER);
        ...
        addXMLObjectParser(Attribute.ATTRIBUTE_PARSER);
        addXMLObjectParser(Attribute.ATTRIBUTES_PARSER);

        addXMLObjectParser(Statistic.PARSER);
        addXMLObjectParser(Parameter.PARSER);
