...
//    @Parseable
    ...
    public HamiltonUpdate(
            ...
            @OperatorWeightAttribute double weight,
            @CoercionModeAttribute CoercionMode mode) {
        this(U, new CompoundParameter("q", parameters), new KineticEnergy.Fixed(massAttributeToMass(mm.getMassMatrix(), Arrays.stream(parameters).mapToInt(Parameter::getDimension).sum())), epsilon, L, alpha, weight, mode);
    }
