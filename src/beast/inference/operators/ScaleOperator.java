...
public class ScaleOperator extends AbstractCoercableOperator {
    ...
    public final double doOperation() throws OperatorFailedException {
        ...
        if (scaleAllIndependently) {
            ...
            if (oldValue == 0) {
                Logger.getLogger("beast.inference").warning("The " + SCALE_OPERATOR +
                        " for " +
    ...
    public String toString() {
        return SCALE_OPERATOR + "(" + variable.getVariableName() + " [" + scaleFactor + ", " + (1.0 / scaleFactor) + "]";
    }
    ...
    public static final XMLObjectParser<ScaleOperator> PARSER = new AbstractXMLObjectParser<ScaleOperator>() {
        ...
        public ScaleOperator parseXMLObject(XMLObject xo) throws XMLParseException {
