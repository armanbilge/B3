...
public class SimpleTree implements MutableTree {
    ...
    public static final XMLObjectParser<SimpleTree> PARSER = new AbstractXMLObjectParser<SimpleTree>() {
        ...
        public SimpleTree parseXMLObject(XMLObject xo) throws XMLParseException {
            ...
            if (usingDates) {
                ...
                for (int i = 0; i < tree.getTaxonCount(); i++) {
                    ...
                    Date date = (Date) tree.getTaxonAttribute(i, DATE);

                    if (date == null) {
                        date = (Date) tree.getNodeAttribute(tree.getExternalNode(i), DATE);
                    }
                ...
                for (int i = 0; i < tree.getInternalNodeCount(); i++) {
                    Date date = (Date) tree.getNodeAttribute(tree.getInternalNode(i), DATE);
