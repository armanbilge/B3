...
public class BeagleTreeLikelihood extends AbstractSinglePartitionTreeLikelihood implements ThreadAwareLikelihood, Serializer.Resumable {
    ...
    public BeagleTreeLikelihood(PatternList patternList,
        ...
        super(TreeLikelihood.TREE_LIKELIHOOD, patternList, treeModel);
            ...
            if (Double.isNaN(logL) || Double.isInfinite(logL)) {
                ...
                if (firstRescaleAttempt && (rescalingScheme == PartialsRescalingScheme.DYNAMIC || rescalingScheme == PartialsRescalingScheme.DELAYED)) {
                    ...
                    if (rescalingScheme == PartialsRescalingScheme.DYNAMIC || (rescalingCount == 0)) {
                        Logger.getLogger("beast.evomodel").info("Underflow calculating likelihood. Attempting a rescaling...");
                    }
                    useScaleFactors = true;
                    recomputeScaleFactors = true;
...
//            final int scaleIndex = scaleBufferHelper.getOffsetIndex(nodeIndex - tipCount);
    ...
    protected int getDerivativePartialsBuffer(final int i) {
        return i + partialBufferHelper.getBufferCount();
    }
...
//    public static final String PREFER_SINGLE_PRECISION = "preferSinglePrecision";
        ...
        public Likelihood parseXMLObject(XMLObject xo) throws XMLParseException {
