...
public class CategorySiteModel extends AbstractModel implements SiteModel {
    ...
    public static final XMLObjectParser<CategorySiteModel> PARSER = new AbstractXMLObjectParser<CategorySiteModel>() {
        ...
        public CategorySiteModel parseXMLObject(XMLObject xo) throws XMLParseException {
