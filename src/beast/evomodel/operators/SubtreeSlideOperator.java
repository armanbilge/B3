...
import beast.inference.operators.OperatorUtils;
...
//                tree.setNodeTrait(j, TRAIT, tmp);
    ...
    public static final XMLObjectParser<SubtreeSlideOperator> PARSER = new AbstractXMLObjectParser<SubtreeSlideOperator>() {
        ...
        public SubtreeSlideOperator parseXMLObject(XMLObject xo) throws XMLParseException {
