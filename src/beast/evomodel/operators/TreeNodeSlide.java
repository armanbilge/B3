...
import beast.evomodel.speciation.SpeciesBindings;
import beast.evomodel.speciation.SpeciesTreeModel;
...
public class TreeNodeSlide extends SimpleMCMCOperator {
  ...
  //  private boolean outgroupOnly = false;
    ...
    public String getOperatorName() {
        return TREE_NODE_REHEIGHT + "(" + tree.getId() + "," + species.getId() + ")";
    }
...
//    }
    ...
    public static final XMLObjectParser<TreeNodeSlide> PARSER = new AbstractXMLObjectParser<TreeNodeSlide>() {

        public String getParserName() {
            return TREE_NODE_REHEIGHT;
        }

        public TreeNodeSlide parseXMLObject(XMLObject xo) throws XMLParseException {
