...
import beast.evolution.coalescent.ScaledDemographic;
...
/**
 * Compute coalescent log-likelihood of a set of gene trees embedded inside one species tree.
 *
...
//            }
    ...
    public static final XMLObjectParser<MultiSpeciesCoalescent> PARSER = new AbstractXMLObjectParser<MultiSpeciesCoalescent>() {
        public static final String SPECIES_COALESCENT = "speciesCoalescent";

        public MultiSpeciesCoalescent parseXMLObject(XMLObject xo) throws XMLParseException {
        ...
        public String getParserDescription() {
            return "Compute coalescent log-likelihood of a set of gene trees embedded inside one species tree.";
        }
