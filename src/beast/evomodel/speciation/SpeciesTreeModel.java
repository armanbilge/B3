...
//        double[] ys = new double[plen + (isRoot ? 2 : 2)];
    ...
    private Double setInitialSplitPopulations(FlexibleTree startTree, NodeRef node, int pos[]) {
        ...
        final String comment = (String) startTree.getNodeAttribute(node, "comment");
        Double p0 = null;
        if (comment != null) {
...
//    };
    ...
    public static final XMLObjectParser<SpeciesTreeModel> PARSER = new AbstractXMLObjectParser<SpeciesTreeModel>() {
        ...
        public SpeciesTreeModel parseXMLObject(XMLObject xo) throws XMLParseException {
            ...
            final Boolean bmp = xo.getAttribute(BMPRIOR, false);
            {
                ...
                if( cxo != null ) {
                    ...
                    Parameter.replaceParameter(cxo, coalPointsPops);
                    ...
                    Parameter.replaceParameter(cxo, coalPointsIndicators);
                } else {
                    // assert ! bmp;
                }
            }
            ...
            Parameter.replaceParameter(cxo, sppSplitPopulations);
