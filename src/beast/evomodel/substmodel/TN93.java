...
public class TN93 extends AbstractNucleotideModel {
    ...
    public static final String TN93_MODEL = NucleotideModelType.TN93.getXMLName();
...
//     }
    ...
    public static final XMLObjectParser<TN93> PARSER = new AbstractXMLObjectParser<TN93>() {
        ...
        public TN93 parseXMLObject(XMLObject xo) throws XMLParseException {
            ...
            Logger.getLogger("beast.evomodel").info("Creating TN93 substitution model. Initial kappa = "
